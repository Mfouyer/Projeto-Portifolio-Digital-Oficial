...
/* ════════════════════════════════════════════════════════════
   ...
   Vídeo agent-team showcase (aprovado pelo Marcos 24/jul ~00:10 —
   NÃO substituir sem autorização explícita dele).
   Mesmo padrão de fix muted do ProjectHeroVideo (commit 9138b06).
   ════════════════════════════════════════════════════════════ */

const OPENCLAUDE_VIDEO_URL =
  'https://pb.mfouyer.com/api/files/pbc_484305853/2haqvo5dbtnenyk/agent_team_video_v2_2026_07_23_22_33_47_w8kkdtw4z9.mp4';
        ...
        <div className="container">
          ...
          <FadeUp>
            <div className="diagram-wrapper">
              ...
              <div className="diagram-svg-wrap"><OpenClaudeArchVideo /></div>
            </div>
          </FadeUp>
